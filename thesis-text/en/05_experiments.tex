...
\begin{figure}
\centering
 \subfloat[$k = 5$]{\includegraphics[width=\textwidth]{ae_samples/tremba_cat.png}}\hfill
 \subfloat[$k = 1$]{\includegraphics[width=\textwidth]{ae_samples/tremba_shark.png}}
...
\begin{figure}
\centering
 \subfloat[$k = \infty$]{\includegraphics[width=0.6\textwidth]{ae_samples/rays_cat_0.1757.png}}\hfill
 \subfloat[$k = 5$]{\includegraphics[width=0.6\textwidth]{ae_samples/rays_cat_0.121.png}}\hfill
 \subfloat[$k = 1$]{\includegraphics[width=0.6\textwidth]{ae_samples/rays_cat_0.0666.png}}
...
\begin{figure}
\centering
 \subfloat[$k = 5$]{\includegraphics[width=0.6\textwidth]{ae_samples/rays_shart_top5.png}}\hfill
 \subfloat[$k = 1$]{\includegraphics[width=0.6\textwidth]{ae_samples/rays_shart_top1.png}}
...
\begin{figure}
\centering
 \subfloat[Sparse-RS frame, width=10px]{\includegraphics[width=0.6\textwidth]{ae_samples/sparse_cat_frame.png}}\hfill
 \subfloat[Sparse-RS noise, $l_0 = 2000$]{\includegraphics[width=0.6\textwidth]{ae_samples/sparse_cat_noise.png}}
...
\section{Transferability evaluation on Google Cloud Vision}
...
\begin{figure}
    \centering
    \includegraphics[width=0.80\textwidth]{scripts/wordcloud_baseline.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.80\textwidth]{scripts/wordcloud_ensemble.png}
