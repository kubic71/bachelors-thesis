...
TODO: cite the paper that explains Guassian noise augmentation in terms of gradinet smoothing.
\begin{figure}
\centering
 \subfloat[25 iterations, 10 gradient estimates per step]{\includegraphics[width=0.48\textwidth]{transfer_attacks/transfer_heatmap/augment_noise_apgd_l2_margin_n_iters_25_eot_iters_10_eps_10.png}}

 \subfloat[250 iterations, 1 gradient estimate per step]{\includegraphics[width=0.48\textwidth]{transfer_attacks/transfer_heatmap/augment_noise_apgd_l2_margin_n_iters_250_eot_iters_1_eps_10.png}}
\caption{Guassian noise augmentation}
\label{fig:apgd_noise_augment}
\end{figure}


Figure \ref{fig:apgd_noise_augment} shows that in the low iteration regime the optimal Guassian-noise augmentation std is somewhere near $std=18$. It also shows that given the same whitebox query budget, it pays off to get a quality gradient estimate.
