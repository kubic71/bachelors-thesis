...
As our experiments were being run on a number of differrent machines with different environments, easily installing AdvPipe reliably and escaping dependency hell became our priority number one. We decided to do away with \href{https://pip.pypa.io/en/stable/}{pip}, that can often leave the Python virtual environment in an inconsistent state and decided to manage our dependencies with an excellent pip alternative \href{https://python-poetry.org/}{Poetry}. We never looked back.
