...
All models (cloud, local) are wrapped as PyTorch \codeword{torch.nn.Modules}. This way they can be used in and plug-and-play manner and passed easily to existing attack algorithms.
